...
*   **Strategy Handoff:** Delegate to the **ConsThinkingAgent** (Sub-Agent). Provide it with the `{topic}`, `shared_memory.json`, and the newly defined `persona.json`.
...
| :----------------- | :--------- | :----------------------------------- | :------------------- |
| **Cons Root Agent**| Root       | `shared_memory.json`, `cons_memory/*.json` | `shared_memory.json`   |
| **ConsPersonaAgent**| Sub-Agent | `shared_memory.json`                   | `persona.json`         |
| **ConsThinkingAgent**| Sub-Agent| `shared_memory.json`, `persona.json`     | `thinking.json`        |
| **ConsCritiqueAgent**| Sub-Agent| `shared_memory.json`, `cons_memory/*.json` | `critique.json`        |
