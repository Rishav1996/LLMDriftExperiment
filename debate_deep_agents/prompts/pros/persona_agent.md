...
3.  **Architect Persona:** (Only if `skip_persona_generation` is `False`). Design a competitor who is biased, unwavering, and tactically positioned to win. Give this persona a unique `persona_id` (e.g., 'pros-v1', 'pros-v2').
