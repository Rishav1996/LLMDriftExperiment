...
class PersonaSchema(BaseModel):
    """
    Simplified schema for the competitive adversarial persona profile (Cons).
    """
    ...
    persona_id: str = Field(..., description="A unique identifier for this persona (e.g., 'cons-v1').")
...
class AgentSchema(BaseModel):
    ...
    round: int = Field(..., description="The current round of the debate.")
    cons_argument: str = Field(..., description="The complete, refined persuasive argument.")
