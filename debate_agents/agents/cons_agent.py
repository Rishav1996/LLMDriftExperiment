...
def get_cons_agent():
    ...
    critique_agent = create_base_agent("ConsCritiqueAgent", "cons/critique_agent.md", "Evaluates arguments.", "cons_critique", CritiqueSchema, planner=BuiltInPlanner(thinking_config=types.ThinkingConfig(include_thoughts=True, thinking_budget=512)), tools=[get_read_json_tool(), get_exit_loop_tool()], callback=None)
