...
3.  **Persist Feedback:** You MUST use the `write_markdown` tool to save your critique to `pros_memory/critique.md`. (Set `filename` to "critique.md" and `content` to your full critique and feedback).
