...
def create_cons_deep_agent():
    ...
    thinking_prompt_path = os.path.join("debate_deep_agents", "prompts", "cons", "thinking_agent.md")
    critique_prompt_path = os.path.join("debate_deep_agents", "prompts", "cons", "critique_agent.md")
